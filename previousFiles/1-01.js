...
//       </ImageBackground>
//    </View>
//       <LinearGradient colors={['rgb(0, 78, 192)', '#000000']} style={{zIndex:2, opacity:1, width: 370, position:'absolute', height:550, paddingTop: 5, paddingBottom: 25,  borderBottomRightRadius: 180, borderTopRightRadius: 190}}>
...
//     <View>
//       <Image style={{position: 'absolute', top: 15, left: 0}}source={fajr}></Image>
//     <View style={{display: 'flex', flexDirection: 'row'}}>
//       <View>
...
//     <View>
//     <Image style={{position: 'absolute', top: 20, left: 0}}source={sunrise}></Image>
...
// <View>
//   <Image style={{position: 'absolute', top: 30, left: 0}} source={sun}></Image>
...
// <View>
// <Image style={{position: 'absolute', top: 10, left: 0}}source={haze}></Image>
...
// <View >
// <Image style={{position: 'absolute', bottom: 5, left: 0}}source={sunset}></Image>
...
//     <View  style={{display: 'flex', flexDirection: 'row'}} >
//     <Image style={{position: 'absolute', bottom: 10, left: 0}}source={moon}></Image>

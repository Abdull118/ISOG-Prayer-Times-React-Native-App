...
export default Home = ({ navigation, route }) => {
  ...
  const getPrayerTimes = async () => {
    try {
      const response = await fetch(
        `https://sparkling-jade-cowboy-boots.cyclic.app/prayers`
      );
      const json = await response.json();
  ...
  const getHadiths = async () => {
    try {
      const response = await fetch(
        `https://sparkling-jade-cowboy-boots.cyclic.app/hadiths`
      );
      const json = await response.json();
  ...
  const getNextPrayer = async () => {
    try {
      const response = await fetch(
        "https://sparkling-jade-cowboy-boots.cyclic.app/nextPrayers",
        {
          method: "PUT",
          headers: {
  ...
  const getAnnouncements = async () => {
    try {
      const response = await fetch(
        `https://sparkling-jade-cowboy-boots.cyclic.app/announcements`
      );
          ...
          <View>
            ...
            <View style={styles.boxes}>
              <View>
                <View style={styles.annoucnementsHeaderContainer}>
                  <Text style={styles.announcementsHeader}>
                    TODAY'S MESSAGE
                  </Text>
                </View>
            ...
            <View style={styles.prayerContainer}>
              ...
              <View
                style={[
                  styles.prayers,
                  nextPrayer == "fajr" ? styles.upcomingPrayer : null,
                ]}
              >
                <Text
                  style={[
                ...
                <Text
                  style={[
                    nextPrayer == "fajr" ? styles.athanTime1 : styles.athanTime,
                  ]}
                >
                  {fajrAthan}
              ...
              <View
                style={[
                  styles.prayers,
                  nextPrayer == "dhuhr" ? styles.upcomingPrayer : null,
                ]}
              >
                <Text
                  style={[
              ...
              <View
                style={[
                  styles.prayers,
                  nextPrayer == "asr" ? styles.upcomingPrayer : null,
                ]}
              >
                <Text
                  style={[
                ...
                <Text
                  style={[
                    nextPrayer == "asr" ? styles.athanTime1 : styles.athanTime,
                  ]}
                >
                  {asrAthan}
                  <Text style={styles.AMPM}>PM</Text>
              ...
              <View
                style={[
                  styles.prayers,
                  nextPrayer == "maghrib" ? styles.upcomingPrayer : null,
                ]}
              >
                <Text
                  style={[
              ...
              <View
                style={[
                  styles.prayers,
                  nextPrayer == "isha" ? styles.upcomingPrayer : null,
                ]}
              >
                <Text
                  style={[
                ...
                <Text
                  style={[
                    nextPrayer == "isha" ? styles.athanTime1 : styles.athanTime,
                  ]}
                >
                  {ishaAthan}
                  <Text style={styles.AMPM}>PM</Text>
          ...
          <View>
            ...
            {countdownTimeHr !== "" ? (
              <View style={styles.nextPrayer}>
                ...
                <Text style={styles.countDown}>
                  {countdownTimeHr}
                  <Text style={styles.HRMN}>HR</Text> {countdownTimeMn}
                  <Text style={styles.HRMN}>MIN</Text>
                </Text>
              </View>
            ) : (
            ...
            <View style={styles.jumuah}>
              <View style={styles.startContainer}>
                <Text style={styles.jumuahPrayer}>
                  01:30<Text style={styles.AMPM2}>PM</Text>
                </Text>
              ...
              <View style={styles.jumuahContainer}>
                <Text style={styles.jumuahPrayer}>
                  01:50<Text style={styles.AMPM2}>PM</Text>
                </Text>
            ...
            <View style={styles.fastingContainer}>
              <View style={styles.suhoorContainer}>
                ...
                <Text style={styles.suhoorAthan}>
                  {fajrAthan}
                  <Text style={styles.AMPM3}>AM</Text>
                </Text>
              ...
              <View style={styles.iftarContainer}>
                ...
                <Text style={styles.iftarAthan}>
                  {maghribAthan}
                  <Text style={styles.AMPM3}>PM</Text>
                </Text>
